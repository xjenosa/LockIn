  ...
  categories: [
    {
      ...
      clues: [
        ...
        { value: 400, clue: "Dinosaurs and a crystal-shaped entrance define this museum at Bloor & Queen's Park.", answer: "What is the ROM (Royal Ontario Museum)?" },
        { value: 600, clue: "This pedestrian-only Victorian industrial neighbourhood is famous for its Christmas Market.", answer: "What is the Distillery District?" },
        { value: 800, clue: "The giant curved twin towers watching over the skating rink at Nathan Phillips Square form this building.", answer: "What is Toronto City Hall?" },
        { value: 1000, clue: "Toronto started life in 1793 as this lakeshore garrison, captured by American invaders 20 years later.", answer: "What is Fort York?" },
      ],
    },
    {
      name: "Canadian Icons",
    ...
    },
    {
      ...
      clues: [
        ...
        { value: 1000, clue: "Ontarians call the Victoria Day long weekend this, after the case of beer that fuels it.", answer: "What is the May two-four?" },
      ],
    },
    {
      name: "Eh? History",
      clues: [
        { value: 200, clue: "Escaped enslaved people followed this secret network north to Canada in the 1800s.", answer: "What is the Underground Railroad?" },
        { value: 400, clue: "Confederation united the first provinces in this year.", answer: "What is 1867?" },
        { value: 600, clue: "This man on the $10 bill (well, formerly) was Canada's first prime minister.", answer: "Who is Sir John A. Macdonald?" },
        { value: 800, clue: "Canada's constitution came home with this 1982 charter of rights attached.", answer: "What is the Charter of Rights and Freedoms?" },
